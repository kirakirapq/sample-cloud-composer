...
from functions import get_sql, get_bq_operator_as_insert_data
...
dag = DAG("TT-TEST_QP02_2021-04-05", default_args=original_args, schedule_interval=schedule_interval)
...
task01 = get_bq_operator_as_insert_data(
  task_id = "get01",
  dag = dag,
  sql = sql,
