...
dag = DAG("TT-TEST_QP06_2021-04-07", default_args=original_args, schedule_interval=schedule_interval)
...
execute_task.make_task_list(task_list1, from_date, to_date, interval).execute_parallel_task().make_task_list(task_list_2, from_date_2, to_date_2, interval_2).execute_series_task()
